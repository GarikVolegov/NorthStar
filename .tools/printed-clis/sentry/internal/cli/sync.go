...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "organizations_environments":
		return db.UpsertOrganizationsEnvironments(data)
	case "eventids":
	...
	case "organizations_teams":
		return db.UpsertOrganizationsTeams(data)
	case "user_teams":
	...
	case "projects_monitors":
		return db.UpsertProjectsMonitors(data)
	case "ownership":
		return db.UpsertOwnership(data)
	case "preprod":
		return db.UpsertPreprod(data)
	case "projects_preprodartifacts":
		return db.UpsertProjectsPreprodartifacts(data)
	case "projects_releases":
		return db.UpsertProjectsReleases(data)
	case "projects_replays":
		return db.UpsertProjectsReplays(data)
	case "stats":
	...
	case "projects_teams":
		return db.UpsertProjectsTeams(data)
	case "user_feedback":
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "dashboards", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/dashboards/", KeyField: ""},
		{Name: "discover", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/discover/saved/", KeyField: ""},
		{Name: "integrations", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/integrations/", KeyField: ""},
		{Name: "organizations_events", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/events/", KeyField: ""},
		{Name: "organizations_issues", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/issues/", KeyField: ""},
		{Name: "organizations_members", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/members/", KeyField: ""},
		{Name: "organizations_monitors", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/monitors/{monitor_id_or_slug}/checkins/", KeyField: ""},
		{Name: "organizations_projects", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/projects/", KeyField: ""},
		{Name: "organizations_releases", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/releases/{version}/deploys/", KeyField: ""},
		{Name: "organizations_replays", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/replays/", KeyField: ""},
		{Name: "organizations_sentry_app_installations", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/sentry-app-installations/", KeyField: ""},
		{Name: "organizations_teams", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/teams/", KeyField: ""},
		{Name: "prevent", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/prevent/owner/{owner}/repository/{repository}/test-results/", KeyField: ""},
		{Name: "project_keys", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/project-keys/", KeyField: ""},
		{Name: "replay_selectors", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/replay-selectors/", KeyField: ""},
		{Name: "repos", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/repos/", KeyField: ""},
		{Name: "sessions", ParentTable: "organizations", ParentIDParam: "organization_id_or_slug", PathTemplate: "/api/0/organizations/{organization_id_or_slug}/sessions/", KeyField: ""},
	}
}
