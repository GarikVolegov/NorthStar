...
func newOrganizationsPreventRetrievesASingleRepositoryForAGivenOwnerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "prevent.retrieves-a-single-repository-for-a-given-owner", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/prevent/owner/{owner}/repository/{repository}/", "mcp:read-only": "true"},
