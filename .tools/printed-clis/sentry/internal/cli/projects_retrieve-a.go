...
func newProjectsRetrieveACmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "projects.retrieve-a", "pp:method": "GET", "pp:path": "/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/", "mcp:read-only": "true"},
