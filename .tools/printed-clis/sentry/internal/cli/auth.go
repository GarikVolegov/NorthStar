...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Sentry",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  sentry-pp-cli auth setup\n  sentry-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "Get a key at: https://sentry.io/settings/account/api/auth-tokens/")
			fmt.Fprintln(w, "  Create an auth token with the scopes your workflow needs (project:read, event:read, etc.).")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export REFERENCE_AUTH_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  sentry-pp-cli auth set-token <token>")
			if !launch {
				return nil
			}
			launchURL := "https://sentry.io/settings/account/api/auth-tokens/"
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !authed {
				...
				fmt.Fprintln(w, "  export REFERENCE_AUTH_TOKEN=\"your-token-here\"")
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  sentry-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("REFERENCE_AUTH_TOKEN") != "" {
				envStillSet = "REFERENCE_AUTH_TOKEN"
			}
