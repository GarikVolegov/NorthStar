...
func newOrganizationsReleasesRetrieveFilesChangedInASCommitsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "releases.retrieve-files-changed-in-a-s-commits", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/releases/{version}/commitfiles/", "mcp:read-only": "true"},
