...
func newOrganizationsPreventGetsSyncingStatusForRepositoriesForAnIntegratedOrgCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "prevent.gets-syncing-status-for-repositories-for-an-integrated-org", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/prevent/owner/{owner}/repositories/sync/", "mcp:read-only": "true"},
