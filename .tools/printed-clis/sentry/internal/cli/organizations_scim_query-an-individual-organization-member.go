...
func newOrganizationsScimQueryAnIndividualOrganizationMemberCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "scim.query-an-individual-organization-member", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/scim/v2/Users/{member_id}", "mcp:read-only": "true"},
