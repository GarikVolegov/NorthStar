...
func newProjectsMembersListAProjectSOrganizationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "members.list-a-project-s-organization", "pp:method": "GET", "pp:path": "/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/members/", "mcp:read-only": "true"},
