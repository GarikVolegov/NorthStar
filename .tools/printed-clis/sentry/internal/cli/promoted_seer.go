...
func newSeerPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "seer.list-ai-models", "pp:method": "GET", "pp:path": "https://.sentry.io/api/0/seer/models/", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://.sentry.io/api/0/seer/models/"
