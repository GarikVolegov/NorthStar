...
func newOrganizationsEventidsResolveAnEventIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "eventids.resolve-an-event-id", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/eventids/{event_id}/", "mcp:read-only": "true"},
