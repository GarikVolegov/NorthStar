...
func newOrganizationsForwardingRetrieveDataForwardersForAnOrganizationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "forwarding.retrieve-data-forwarders-for-an-organization", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/forwarding/", "mcp:read-only": "true"},
