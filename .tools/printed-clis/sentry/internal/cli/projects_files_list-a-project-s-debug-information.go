...
func newProjectsFilesListAProjectSDebugInformationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "files.list-a-project-s-debug-information", "pp:method": "GET", "pp:path": "/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/files/dsyms/", "mcp:read-only": "true"},
