...
func newOrganizationsDiscoverRetrieveAnOrganizationSSavedQueryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "discover.retrieve-an-organization-s-saved-query", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/discover/saved/{query_id}/", "mcp:read-only": "true"},
