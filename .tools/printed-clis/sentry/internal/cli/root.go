...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sentry-pp-cli",
		Short: "Manage sentry resources via the sentry API",
		Long: `Manage sentry resources via the sentry API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'sentry-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
