...
func newOrganizationsSentryAppsRetrieveTheCustomIntegrationsCreatedByAnOrganizationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "sentry-apps.retrieve-the-custom-integrations-created-by-an-organization", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/sentry-apps/", "mcp:read-only": "true"},
