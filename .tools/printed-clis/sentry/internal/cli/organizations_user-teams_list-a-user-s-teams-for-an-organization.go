...
func newOrganizationsUserTeamsListAUserSTeamsForAnOrganizationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "user-teams.list-a-user-s-teams-for-an-organization", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/user-teams/", "mcp:read-only": "true"},
