...
func newOrganizationsRelayUsageListAnOrganizationSTrustedRelaysCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "relay-usage.list-an-organization-s-trusted-relays", "pp:method": "GET", "pp:path": "/api/0/organizations/{organization_id_or_slug}/relay_usage/", "mcp:read-only": "true"},
