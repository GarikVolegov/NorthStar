...
func newProjectsFiltersListAProjectSDataCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "filters.list-a-project-s-data", "pp:method": "GET", "pp:path": "/api/0/projects/{organization_id_or_slug}/{project_id_or_slug}/filters/", "mcp:read-only": "true"},
