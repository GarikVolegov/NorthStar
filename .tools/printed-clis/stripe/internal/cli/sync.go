...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "accounts_bank_accounts":
		return db.UpsertAccountsBankAccounts(data)
	case "capabilities":
		return db.UpsertCapabilities(data)
	case "accounts_external_accounts":
		return db.UpsertAccountsExternalAccounts(data)
	case "login_links":
	...
	case "application_fees_refund":
		return db.UpsertApplicationFeesRefund(data)
	...
	case "dispute":
		return db.UpsertDispute(data)
	case "charges_refund":
		return db.UpsertChargesRefund(data)
	...
	case "customers_bank_accounts":
		return db.UpsertCustomersBankAccounts(data)
	case "cards":
	...
	case "mandate_notifications":
		return db.UpsertMandateNotifications(data)
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"linked-accounts":                     "/v1/linked_accounts",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "accounts_external_accounts", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/accounts/{account}/external_accounts", KeyField: ""},
		{Name: "amount_details_line_items", ParentTable: "payment-intents", ParentIDParam: "intent", PathTemplate: "/v1/payment_intents/{intent}/amount_details_line_items", KeyField: ""},
		{Name: "application_fees_refunds", ParentTable: "application-fees", ParentIDParam: "id", PathTemplate: "/v1/application_fees/{id}/refunds", KeyField: ""},
		{Name: "cards", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/cards", KeyField: ""},
		{Name: "cash_balance_transactions", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/cash_balance_transactions", KeyField: ""},
		{Name: "charges_refunds", ParentTable: "charges", ParentIDParam: "charge", PathTemplate: "/v1/charges/{charge}/refunds", KeyField: ""},
		{Name: "computed_upfront_line_items", ParentTable: "quotes", ParentIDParam: "quote", PathTemplate: "/v1/quotes/{quote}/computed_upfront_line_items", KeyField: ""},
		{Name: "credit_notes_lines", ParentTable: "credit-notes", ParentIDParam: "credit_note", PathTemplate: "/v1/credit_notes/{credit_note}/lines", KeyField: ""},
		{Name: "customers_balance_transactions", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/balance_transactions", KeyField: ""},
		{Name: "customers_bank_accounts", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/bank_accounts", KeyField: ""},
		{Name: "customers_payment_methods", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/payment_methods", KeyField: ""},
		{Name: "customers_sources", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/sources", KeyField: ""},
		{Name: "customers_subscriptions", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/subscriptions", KeyField: ""},
		{Name: "customers_tax_ids", ParentTable: "customers", ParentIDParam: "customer", PathTemplate: "/v1/customers/{customer}/tax_ids", KeyField: ""},
		{Name: "features", ParentTable: "products", ParentIDParam: "product", PathTemplate: "/v1/products/{product}/features", KeyField: ""},
		{Name: "financial_connections", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/financial_connections/accounts/{account}/owners", KeyField: ""},
		{Name: "invoices_lines", ParentTable: "invoices", ParentIDParam: "invoice", PathTemplate: "/v1/invoices/{invoice}/lines", KeyField: ""},
		{Name: "owners", ParentTable: "linked-accounts", ParentIDParam: "account", PathTemplate: "/v1/linked_accounts/{account}/owners", KeyField: ""},
		{Name: "payment_links_line_items", ParentTable: "payment-links", ParentIDParam: "payment_link", PathTemplate: "/v1/payment_links/{payment_link}/line_items", KeyField: ""},
		{Name: "people", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/accounts/{account}/people", KeyField: ""},
		{Name: "persons", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/accounts/{account}/persons", KeyField: ""},
		{Name: "quotes_line_items", ParentTable: "quotes", ParentIDParam: "quote", PathTemplate: "/v1/quotes/{quote}/line_items", KeyField: ""},
		{Name: "reversals", ParentTable: "transfers", ParentIDParam: "id", PathTemplate: "/v1/transfers/{id}/reversals", KeyField: ""},
	}
}
