		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export STRIPE_BEARER_AUTH=<your-key>"
					report["auth_key_url"] = "https://dashboard.stripe.com/apikeys"
					report["auth_instructions"] = "Use a test mode key (sk_test_*) unless you intend to charge live cards."
				} else {
					authConfigured = true
			...
			if os.Getenv("STRIPE_BEARER_AUTH") != "" {
				authEnvSet = append(authEnvSet, "STRIPE_BEARER_AUTH")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "STRIPE_BEARER_AUTH")
			}
			switch {
