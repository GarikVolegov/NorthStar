...
large datasets as it has no memory pressure.`,
  ...
  openai-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  openai-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  openai-pp-cli export <resource> --format jsonl | jq '.id'`,
