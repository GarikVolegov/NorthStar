...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "openai-pp-cli",
		Short: "Manage openai resources via the openai API",
		Long: `Manage openai resources via the openai API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'openai-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("openai-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'openai-pp-cli profile list')")
	...
	rootCmd.AddCommand(newVectorStoresCmd(flags))
	...
	rootCmd.AddCommand(newModerationsPromotedCmd(flags))
