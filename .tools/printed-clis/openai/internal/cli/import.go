...
but do not stop the import.`,
  ...
  openai-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openai-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openai-pp-cli import <resource> --input -`,
