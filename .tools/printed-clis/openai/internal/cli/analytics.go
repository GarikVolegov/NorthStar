...
Data must be synced first with the sync command.`,
  ...
  openai-pp-cli analytics --type messages

  # Group by a field
  openai-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  openai-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
