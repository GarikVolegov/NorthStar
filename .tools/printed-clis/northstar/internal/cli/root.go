...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "northstar-pp-cli",
		Short: "Manage northstar resources via the northstar API",
		Long: `Manage northstar resources via the northstar API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'northstar-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("northstar-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'northstar-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSectorsCmd(flags))
	rootCmd.AddCommand(newTestSessionsCmd(flags))
