...
but do not stop the import.`,
  ...
  northstar-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  northstar-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | northstar-pp-cli import <resource> --input -`,
