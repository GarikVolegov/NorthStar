...
large datasets as it has no memory pressure.`,
  ...
  northstar-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  northstar-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  northstar-pp-cli export <resource> --format jsonl | jq '.id'`,
