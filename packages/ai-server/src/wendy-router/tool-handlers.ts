...
type WendyActionStatus = "draft" | "needs_confirmation" | "running" | "done" | "failed";
type WendyActionRisk = "low" | "medium" | "high";
...
export async function executeToolCall(
  ...
  switch (name) {
    ...
    case "save_objective":             result = proposeSaveObjective(args as any); break;
    case "update_objective_progress":  result = proposeUpdateObjectiveProgress(args as any); break;
    ...
    case "save_business_idea":         result = proposeSaveBusinessIdea(args as any); break;
    case "add_calendar_event":         result = proposeCalendarEvent(args as any); break;
