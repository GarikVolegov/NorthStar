...
const QUICK_IDENTITY_PATTERNS = /^(ciao|hey|hei|ehi|salve|buongiorno|buonasera|hru|come stai\??|come va\??|tutto bene\??|grazie|ok|perfetto|va bene|chi sei\??|cosa sai fare\??|che cosa sai fare\??|come funziona wendy\??|presentati|aiutami a capire cosa puoi fare|hi|hello|how are you\??|how's it going\??|everything good\??|thanks|perfect|all good\??|who are you\??|what can you do\??|what do you do\??|how does wendy work\??|introduce yourself|help me understand what you can do|hola|que tal\??|como estas\??|como va\??|todo bien\??|gracias|perfecto|va bien\??|quien eres\??|que sabes hacer\??|que haces\??|como funciona wendy\??|salut|ca va\??|tout va bien\??|merci|d'accord|parfait|qui etes-vous\??|que savez-vous faire\??|que faites-vous\??|comment fonctionne wendy\??|presentez-vous|aidez-moi a comprendre ce que vous pouvez faire)$/i;
