// Static rabbit knowledge base (care guides, food safety, breeds) for Wendy rabbit tools.
// ── Care guides ───────────────────────────────────────────────────────────────
...
export const FOOD_SAFETY_DATA: Record<string, FoodEntry> = {
...
export const BREED_DATA: Record<string, BreedEntry> = {
  dutch: {
