/**
 * DashboardCrescita.tsx — PLACEHOLDER
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-[20px] font-bold text-[#dce6f5]">In Crescita</h1>
      ...
      <p className="text-[13px] text-[#4a5a75] mb-6 mt-4">
        Sai dove vuoi arrivare. Presto troverai qui streak obiettivi,
        certificazioni consigliate e il tuo ranking nel settore.
      </p>
      <Link href="/percorso"
