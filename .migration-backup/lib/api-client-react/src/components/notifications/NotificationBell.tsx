  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        aria-expanded={open}
        aria-haspopup="true"
        className="relative p-2 rounded-lg text-[#7c8db5] hover:text-[#dce6f5] hover:bg-white/[0.06]
                   transition-colors focus-visible:outline focus-visible:outline-2
                   focus-visible:outline-[#4a6fa1] focus-visible:outline-offset-2"
      >
        ...
        {open && (
          <motion.div
            ...
            className="
              ...
              bg-[#0d1421] border border-white/[0.08] rounded-xl
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]">
              <span className="text-[13px] font-semibold text-[#dce6f5]">
                Notifiche
                {unreadCount > 0 && (
                  <span className="ml-2 text-[11px] font-medium text-[#4a6fa1]">({unreadCount})</span>
                )}
              </span>
              {notifications.length > 0 && (
                <span className="text-[11px] text-[#4a5a75]">
            ...
            <div className="max-h-[380px] overflow-y-auto">
              {notifications.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                  <Bell className="w-8 h-8 text-[#2a3550] mb-3" />
                  <p className="text-[13px] text-[#7c8db5]">Nessuna notifica</p>
                  <p className="text-[11px] text-[#4a5a75] mt-1">
            ...
            {notifications.length > 0 && (
              <div className="px-4 py-2.5 border-t border-white/[0.06]">
                <a
                  ...
                  className="text-[12px] text-[#4a6fa1] hover:text-[#7eb3ff] transition-colors"
                >
