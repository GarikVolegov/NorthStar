  ...
  return (
    <div className="container max-w-lg mx-auto px-4 py-24 flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-medium text-primary uppercase tracking-wider">Benvenuto in Premium</span>
      </div>
      ...
      <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
        Il tuo accesso Premium è ora attivo. Puoi iniziare subito ad esplorare la Wiki AI, il grafo della conoscenza e la tua roadmap personalizzata.
      </p>

      <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
        <Button asChild size="lg" className="rounded-full px-8 h-13">
          <Link href="/">
            Esplora ora <ArrowRight className="ml-2 w-5 h-5" />
          </Link>
        </Button>
