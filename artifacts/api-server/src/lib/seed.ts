...
const SECTORS = [
  ...
  {
    name: "Architettura & Design degli Spazi",
    description: "Progettazione di edifici, interni, paesaggi e infrastrutture. Settore creativo-tecnico che fonde estetica, funzionalità e sostenibilità.",
    riasecTypes: ["A", "R", "I"],
    skills: ["CAD/BIM", "Progettazione architettonica", "Sostenibilità", "Urban planning", "Render 3D"],
    avgSalaryMin: 24000,
    avgSalaryMax: 90000,
    growthRate: 8,
    automationRisk: "low" as const,
    scalability: "medium" as const,
    trend: "stable" as const,
    timeToAutonomy: "5-7 anni con abilitazione",
    advantages: ["Alta creatività", "Impatto visibile sul territorio", "Varietà di progetti"],
    disadvantages: ["Iter abilitativo lungo", "Compensi iniziali bassi", "Dipendenza dai cicli edilizi"],
    opportunities: ["Architetto", "Interior Designer", "Urban Planner", "BIM Manager", "Paesaggista"],
    icon: "building",
    color: "#92400e",
  },
  {
    name: "Ricerca & Accademia",
    description: "Ricerca scientifica, pubblicazioni, insegnamento universitario e trasferimento tecnologico. Percorso vocazionale ad alta autonomia intellettuale.",
    riasecTypes: ["I", "A", "C"],
    skills: ["Metodo scientifico", "Pubblicazione accademica", "Statistica avanzata", "Grant writing", "Divulgazione"],
    avgSalaryMin: 22000,
    avgSalaryMax: 80000,
    growthRate: 5,
    automationRisk: "low" as const,
    ...
    trend: "stable" as const,
    timeToAutonomy: "8-12 anni con dottorato e post-doc",
    advantages: ["Autonomia intellettuale massima", "Impatto a lungo termine", "Mobilità internazionale"],
    disadvantages: ["Percorso lungo e precario", "Finanziamenti scarsi", "Alta competizione accademica"],
    opportunities: ["Ricercatore", "Professore Associato", "Data Scientist in R&D", "Technology Transfer Officer", "Science Policy Advisor"],
    icon: "flask-conical",
    color: "#5b21b6",
  },
  {
    name: "Agricoltura & AgriTech",
    description: "Produzione alimentare, agricoltura di precisione, AgriTech e sostenibilità delle filiere. Settore in forte innovazione tecnologica.",
    riasecTypes: ["R", "I", "S"],
    skills: ["Agronomia", "IoT agricolo", "Sostenibilità", "Supply chain alimentare", "Precision farming"],
    avgSalaryMin: 20000,
    avgSalaryMax: 65000,
    growthRate: 12,
    automationRisk: "medium" as const,
    scalability: "medium" as const,
    trend: "growing" as const,
    timeToAutonomy: "2-4 anni",
    advantages: ["Settore essenziale", "Innovazione tecnologica crescente", "Impatto ambientale positivo"],
    disadvantages: ["Stagionalità", "Margini spesso bassi", "Dipendenza meteo"],
    opportunities: ["Agronomo", "AgriTech Specialist", "Food Supply Chain Manager", "Precision Farming Expert", "Sustainability Agronomist"],
    icon: "leaf",
    color: "#15803d",
  },
  {
    name: "Energia & Green Economy",
    description: "Energie rinnovabili, efficienza energetica, mobilità sostenibile e transizione ecologica. Mercato in rapida crescita trainato dalla politica europea.",
    riasecTypes: ["R", "I", "E"],
    skills: ["Energie rinnovabili", "Efficienza energetica", "ESG", "Project management", "Regolatorio energetico"],
    avgSalaryMin: 28000,
    avgSalaryMax: 110000,
    growthRate: 22,
    automationRisk: "low" as const,
    scalability: "high" as const,
    trend: "growing" as const,
    timeToAutonomy: "2-5 anni",
    advantages: ["Mercato in forte crescita", "Incentivi pubblici abbondanti", "Impatto sociale positivo"],
    disadvantages: ["Dipendenza dalle policy", "Tempi lunghi di permitting", "Alta volatilità regolatoria"],
    opportunities: ["Energy Manager", "Renewable Energy Consultant", "ESG Analyst", "Sustainability Manager", "Green Project Developer"],
    icon: "zap",
    color: "#16a34a",
  },
  {
    name: "Sport & Performance",
    description: "Coaching sportivo, performance mentale, sports business, sport tech e medicina sportiva. Settore in crescita grazie alla sportivizzazione della società.",
    riasecTypes: ["R", "S", "E"],
    skills: ["Coaching", "Performance analysis", "Nutrizione sportiva", "Sports marketing", "Mental coaching"],
    avgSalaryMin: 18000,
    avgSalaryMax: 80000,
    growthRate: 14,
    automationRisk: "low" as const,
    scalability: "medium" as const,
    trend: "growing" as const,
    timeToAutonomy: "3-5 anni",
    advantages: ["Passione come lavoro", "Alta varietà di ruoli", "Impatto diretto sulle persone"],
    disadvantages: ["Redditi variabili", "Alta competitività", "Dipendenza dal calendario sportivo"],
    opportunities: ["Personal Trainer", "Sport Scientist", "Sports Agent", "Athletic Director", "Mental Performance Coach"],
    icon: "trophy",
    color: "#d97706",
  },
  {
    name: "Logistica & Supply Chain",
    description: "Gestione flussi merci, magazzino, trasporti e ottimizzazione supply chain globale. Settore strategico in trasformazione digitale con l'automazione.",
    riasecTypes: ["C", "R", "E"],
    skills: ["Supply chain management", "WMS/ERP", "Lean logistics", "Import/export", "Demand planning"],
    avgSalaryMin: 25000,
    avgSalaryMax: 85000,
    growthRate: 11,
    automationRisk: "medium" as const,
    ...
    trend: "growing" as const,
    timeToAutonomy: "2-4 anni",
    advantages: ["Alta domanda globale", "Ruoli operativi e strategici", "Digitalizzazione in atto"],
    disadvantages: ["Alta pressione operativa", "Imprevedibilità esterna (geopolitica, clima)", "Turni e reperibilità"],
    opportunities: ["Supply Chain Manager", "Logistic Analyst", "Procurement Manager", "Operations Director", "Last Mile Specialist"],
    icon: "package",
    color: "#0e7490",
  },
  {
    name: "Media & Giornalismo",
    description: "Produzione di contenuti editoriali, giornalismo digitale, podcasting e media distribution. Settore in trasformazione verso formati digitali e creator economy.",
    riasecTypes: ["A", "S", "E"],
    skills: ["Scrittura", "Storytelling", "SEO editoriale", "Video production", "Social media"],
    avgSalaryMin: 18000,
    avgSalaryMax: 70000,
    growthRate: 6,
    automationRisk: "medium" as const,
    ...
    trend: "stable" as const,
    timeToAutonomy: "2-5 anni",
    advantages: ["Creatività al centro", "Impatto culturale ampio", "Flessibilità lavorativa"],
    disadvantages: ["Settore in contrazione tradizionale", "Compensi bassi all'inizio", "Alta precarietà"],
    opportunities: ["Giornalista", "Content Director", "Podcast Producer", "Video Journalist", "Newsletter Editor"],
    icon: "newspaper",
    color: "#1e40af",
  },
  {
    name: "Moda & Lusso",
    description: "Fashion design, brand management, retail del lusso e sostenibilità nel fashion. Settore creativo con forte connotazione italiana nel panorama globale.",
    riasecTypes: ["A", "E", "C"],
    skills: ["Fashion design", "Visual merchandising", "Brand strategy", "Sostenibilità moda", "Supply chain moda"],
    avgSalaryMin: 22000,
    avgSalaryMax: 120000,
    growthRate: 9,
    automationRisk: "low" as const,
    scalability: "high" as const,
    trend: "stable" as const,
    timeToAutonomy: "4-7 anni",
    advantages: ["Made in Italy molto valorizzato", "Altissima creatività", "Export globale"],
    disadvantages: ["Stage spesso non retribuiti", "Competizione internazionale", "Stagionalità"],
    opportunities: ["Fashion Designer", "Brand Manager", "Buyer", "Visual Merchandiser", "Sustainability Fashion Manager"],
    icon: "shopping-bag",
    color: "#be185d",
  },
  {
    name: "Diritto & Compliance",
    description: "Consulenza legale, compliance aziendale, diritto del lavoro e privacy. Professione liberale in evoluzione verso specializzazioni digitali e regolatorio tech.",
    riasecTypes: ["C", "E", "I"],
    skills: ["Diritto civile/commerciale", "GDPR", "Compliance", "Contrattualistica", "RegTech"],
    avgSalaryMin: 28000,
    avgSalaryMax: 150000,
    growthRate: 7,
    automationRisk: "low" as const,
    scalability: "medium" as const,
    trend: "stable" as const,
    timeToAutonomy: "5-8 anni con abilitazione",
    advantages: ["Alta stabilità", "Compensi elevati con esperienza", "Rilevanza trasversale"],
    disadvantages: ["Percorso abilitativo lungo", "Aggiornamento continuo", "Alta pressione nelle grandi law firm"],
    opportunities: ["Avvocato", "DPO", "Compliance Manager", "In-house Counsel", "Legal Tech Specialist"],
    icon: "scale",
    color: "#374151",
  },
  {
    name: "Farmaceutico & Life Sciences",
    description: "Sviluppo farmaci, clinical trial, regulatory affairs e biotech. Industria ad alta barriera all'ingresso ma con stipendi e stabilità elevatissimi.",
    riasecTypes: ["I", "C", "R"],
    skills: ["Regulatory affairs", "Clinical data management", "Biostatistica", "GMP/GCP", "Drug development"],
    avgSalaryMin: 30000,
    avgSalaryMax: 130000,
    growthRate: 13,
    automationRisk: "low" as const,
    scalability: "medium" as const,
    trend: "growing" as const,
    timeToAutonomy: "5-8 anni",
    advantages: ["Alta stabilità", "Impatto sulla salute globale", "Stipendi competitivi"],
    disadvantages: ["Iter regolatorio lungo", "Alta specializzazione richiesta", "Cultura spesso corporate"],
    opportunities: ["Regulatory Affairs Manager", "Clinical Research Associate", "Medical Science Liaison", "Biostatistician", "Quality Assurance Specialist"],
    icon: "pill",
    color: "#0891b2",
  },
  {
    name: "Psicologia & Benessere Mentale",
    description: "Psicoterapia, coaching psicologico, neuroscienze applicate e mental health tech. Settore in forte espansione socioculturale.",
    riasecTypes: ["S", "I", "A"],
    skills: ["Psicoterapia", "Assessment psicologico", "CBT/ACT", "Psicologia del lavoro", "Coaching"],
    avgSalaryMin: 20000,
    avgSalaryMax: 90000,
    growthRate: 18,
    automationRisk: "low" as const,
    scalability: "medium" as const,
    trend: "growing" as const,
    timeToAutonomy: "6-9 anni con specializzazione",
    advantages: ["Impatto profondo sulle persone", "Autonomia professionale", "Crescente domanda sociale"],
    disadvantages: ["Percorso formativo lungo e costoso", "Elevato investimento emotivo", "Scarsi rimborsi SSN"],
    opportunities: ["Psicologo clinico", "Psicoterapeuta", "Neuropsicologista", "Psicologo del lavoro", "Mental Health Coach"],
    icon: "brain",
    color: "#7c3aed",
  },
  {
    name: "Elettronica & Manifattura Avanzata",
    description: "Progettazione elettronica, automazione industriale, robotica e manifattura 4.0. Il cuore del made in Italy industriale in transizione digitale.",
    riasecTypes: ["R", "I", "C"],
    skills: ["PCB design", "PLC/SCADA", "Robotica", "IoT industriale", "Lean manufacturing"],
    avgSalaryMin: 28000,
    avgSalaryMax: 95000,
    growthRate: 10,
    automationRisk: "medium" as const,
    ...
    trend: "stable" as const,
    timeToAutonomy: "3-5 anni",
    advantages: ["Alta domanda in distretti industriali", "Stipendi solidi", "Ruoli concreti e tangibili"],
    disadvantages: ["Poca flessibilità geografica", "Aggiornamento costante", "Spesso locale e non remoto"],
    opportunities: ["Elettronico", "Automation Engineer", "Robotics Engineer", "IoT Developer", "Production Manager"],
    icon: "cpu",
    color: "#f59e0b",
  },
  {
    name: "No Profit & Cooperazione Internazionale",
    description: "ONG, fundraising, cooperazione allo sviluppo, advocacy e social enterprise. Settore motivazionale ad alto impatto sociale e bassa scalabilità economica.",
    riasecTypes: ["S", "E", "A"],
    skills: ["Fundraising", "Project management umanitario", "Grant writing", "Advocacy", "M&E"],
    avgSalaryMin: 18000,
    avgSalaryMax: 55000,
    growthRate: 6,
    automationRisk: "low" as const,
    scalability: "low" as const,
    trend: "stable" as const,
    timeToAutonomy: "3-6 anni",
    advantages: ["Lavoro con un forte senso", "Comunità motivata", "Mobilità internazionale"],
    disadvantages: ["Stipendi bassi", "Instabilità dei finanziamenti", "Burnout frequente"],
    opportunities: ["Project Manager ONG", "Fundraiser", "Cooperante internazionale", "Social Impact Analyst", "Grant Writer"],
    icon: "heart-handshake",
    color: "#e11d48",
  },
  {
    name: "Intelligenza Artificiale & Machine Learning",
    description: "Sviluppo di modelli AI, LLM, computer vision, NLP e MLOps. Il settore più caldo degli ultimi anni con domanda esplosiva e compensi al top.",
    riasecTypes: ["I", "R", "C"],
    skills: ["Python", "Deep learning", "LLM fine-tuning", "MLOps", "Feature engineering"],
    avgSalaryMin: 40000,
    avgSalaryMax: 200000,
    growthRate: 45,
    automationRisk: "low" as const,
    ...
    trend: "growing" as const,
    timeToAutonomy: "2-4 anni",
    advantages: ["Stipendi ai massimi livelli", "Domanda globale esplosiva", "Impatto trasformativo"],
    disadvantages: ["Cambiamento rapidissimo", "Barriera tecnica alta", "Alta competizione globale"],
    opportunities: ["ML Engineer", "AI Researcher", "LLM Specialist", "Computer Vision Engineer", "MLOps Engineer"],
    icon: "brain-circuit",
    color: "#6d28d9",
  },
];
