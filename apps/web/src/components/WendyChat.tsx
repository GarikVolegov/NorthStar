...
export function WendyChat({
  ...
  return (
    <>
      ...
      <div
        className={[
          "flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-background/90 shadow-2xl backdrop-blur-xl",
          className,
        ].join(" ")}
      >
        {/* Header */}
              ...
              >
                {msg.role === "error" ? (
                  ...
                  >
                    {msg.uiTool ? (
                      <UiToolRenderer
                        name={msg.uiTool.name}
                        args={msg.uiTool.args}
                      />
                    ) : (
                    ...
                    {msg.role === "assistant" &&
                      msg.actions?.map((action) => (
                        <WendyActionCard
                          ...
                          action={action}
                          onConfirm={() =>
                            void confirmAction(msg.id, action.id)
                          }
        ...
        <div className="border-t border-white/10 bg-background/55 px-3 pb-3 pt-2 backdrop-blur">
          ...
          <form
            ...
            className="flex items-end gap-2 rounded-3xl border border-input bg-background/90 p-2 shadow-sm"
          >
            <textarea
              ref={inputRef}
