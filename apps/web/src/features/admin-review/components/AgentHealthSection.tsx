                  ...
                  <Badge
                    className={
                      agent.status === "healthy"
                        ? "bg-success-surface text-success border-success-muted"
                        : agent.status === "degraded"
                          ? "bg-warning-surface text-warning border-warning-muted"
                          : "bg-danger-surface text-danger border-danger-muted"
                    }
                  >
                    {agent.status === "healthy"
                      ? "Sano"
                ...
                <div className="text-center p-2 rounded-lg bg-muted/40">
                  <p
                    className={`text-lg font-bold ${
                      agent.successRate30d >= 95
                        ? "text-success"
                        : agent.successRate30d >= 80
                          ? "text-warning"
                          : "text-danger"
                    }`}
                  >
