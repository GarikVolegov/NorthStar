...
import { MINI_H, MINI_W } from "./knowledgeGraphUtils";

export interface KnowledgeGraphMinimapProps {
  nodes: KNode[];
...
export const KnowledgeGraphMinimap = memo(
  function KnowledgeGraphMinimap({
    nodes,
    view,
    svgRef,
    onPan,
