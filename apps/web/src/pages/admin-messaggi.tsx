...
export default function AdminMessaggi() {
  ...
  const subjectCounts = Object.keys(SUBJECTS).reduce<Record<string, number>>(
    (acc, k) => {
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        <span
                          className={cn(
                            ...
                            SUBJECT_COLORS[msg.subject] ??
                              SUBJECT_COLORS["altro"],
                          )}
                        >
