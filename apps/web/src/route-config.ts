...
export const routes: RouteConfig[] = [
  ...
  { path: "/accedi", component: () => import("@/pages/login"), guard: "publicOnly", layout: "default", title: "Accesso" },
  { path: "/registrati", component: () => import("@/pages/register"), guard: "publicOnly", layout: "default", title: "Registrazione" },
  ...
  { path: "/abbonamento", component: () => import("@/pages/abbonamento"), guard: "public", layout: "default", title: "Abbonamento" },
