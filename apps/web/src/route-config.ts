...
export const routes: RouteConfig[] = [
  ...
  { path: "/abbonamento", component: () => import("@/pages/abbonamento"), guard: "protected", layout: "default", title: "Abbonamento" },
  ...
  { path: "/mood", component: () => import("@/pages/mood"), guard: "protected", layout: "default", title: "Mood check-in" },
  ...
  { path: "/social/feed", component: () => import("@/pages/social/feed"), guard: "protected", layout: "default", title: "Social feed" },
  { path: "/social/leaderboard", component: () => import("@/pages/social/leaderboard"), guard: "protected", layout: "default", title: "Leaderboard" },
  { path: "/social/chat", component: () => import("@/pages/social/chat"), guard: "protected", layout: "default", title: "Social chat" },
  { path: "/social/profilo", component: () => import("@/pages/social/profilo"), guard: "protected", layout: "default", title: "Profilo social" },
