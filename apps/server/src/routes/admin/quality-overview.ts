...
import { aiRequestLogTable, coachSessionsTable, db, qualityMetrics, responseFeedbackTable, supervisorLogs } from "@workspace/db";
...
export function registerQualityOverviewRoute(router: Router): void {
