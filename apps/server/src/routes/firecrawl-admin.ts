 ...
 *
 * Endpoints (tutti admin):
 *   GET  /api/admin/firecrawl/health                 — verifica servizio
 *   POST /api/admin/firecrawl/scrape                 — scrape preview (no ingest)
 *   POST /api/admin/firecrawl/sources/:id/ingest-url   — scrape URL + ingest
 *   POST /api/admin/firecrawl/sources/:id/ingest-crawl — crawl sito + ingest
 */
